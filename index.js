...
var filename = "recording-" + getDateString() + ".mpeg";
...
function writeChunk(chunk) {
    ...
    // fs.appendFileSync(filename, Buffer.from(chunk));
}
...
(function () {
    ...
    jsmpeg.prototype.startRecording = function (callback) {
        ...
        // this.recordBuffers.push(startChunk);
    ...
    jsmpeg.prototype.recordFrame = function () {
        ...
        var frameChunk = new Uint8Array(this.buffer.bytes.subarray(8, this.buffer.writePos));
        // this.recordBuffers.push(frameChunk);
        writeChunk(frameChunk);
...
var player = null;
var client = null;
var address = 'ws://192.168.86.39/ws';
